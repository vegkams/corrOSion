...
register_bitfields! {
    ...
    CR [
        ...
        /// Date reception occurs for either UART signals or SIR signals depending on the setting of
        ...
        /// Data transmission occurs for either UART signals or SIR signals depending on the setting of
        /// the SIREN bit. When the UART is disabled in the middle of transmission, it
